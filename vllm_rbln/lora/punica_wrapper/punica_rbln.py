...
class PunicaWrapperRBLN(PunicaWrapperBase):
    ...
    def add_lora_logits(self,
        ...
        lora_a_w = lora_a_w.view(-1, lora_a_w.shape[2]).transpose(0, 1)
        lora_b_w = lora_b_stacked[0].transpose(1, 2)
        lora_b_w = lora_b_w.view(-1, lora_b_w.shape[2])
        out = x @ lora_a_w
        # TODO: apply mask to out
        out = out @ lora_b_w
        y += out * scale
